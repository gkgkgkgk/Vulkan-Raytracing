...
GraphicsPipeline::GraphicsPipeline(Device* _device, RenderPass* _renderPass, DescriptorSetLayout *_descriptorSetLayout) {
    ...
    // get the binding descriptions for vertices
    ...
    pipelineLayoutInfo.pSetLayouts = &_descriptorSetLayout->descriptorSetLayout;
